...
import com.example.anbiel.databinding.ActivityHomeBinding
    ...
    private fun buscador() {
        ...
        myRef.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                ...
                Toast.makeText(this@HomeActivity, "Error al obtener los datos de la base de datos: $error", Toast.LENGTH_SHORT).show()
            }
        })
    }
