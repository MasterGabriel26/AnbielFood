...
import com.example.anbiel.databinding.ActivityTacosBinding
...
class TacosActivity() : AppCompatActivity() {
    private lateinit var binding : ActivityTacosBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityTacosBinding.inflate(layoutInflater)
    ...
    private fun buscador() {
        ...
        myRef.addValueEventListener(object : ValueEventListener {
                ...
                searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
                    ...
                    override fun onQueryTextChange(newText: String): Boolean {
                        ...
                        val filteredList = items.filter {
                            it?.name?.contains(newText, ignoreCase = true) == true && it.category == "Tacos"
                        }
            ...
            override fun onCancelled(error: DatabaseError) {
                ...
                Toast.makeText(this@TacosActivity, "Error al obtener los datos de la base de datos: $error", Toast.LENGTH_SHORT).show()
            }
        })
    }
