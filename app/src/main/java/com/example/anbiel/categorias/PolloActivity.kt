...
import com.example.anbiel.databinding.ActivityPolloBinding
    ...
    private fun buscador() {
        ...
        myRef.addValueEventListener(object : ValueEventListener {
                ...
                searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
                    ...
                    override fun onQueryTextChange(newText: String): Boolean {
                        ...
                        val filteredList = items.filter {
                            it?.name?.contains(newText, ignoreCase = true) == true && it.category == "Pollo"
                        }
            ...
            override fun onCancelled(error: DatabaseError) {
                ...
                Toast.makeText(this@PolloActivity, "Error al obtener los datos de la base de datos: $error", Toast.LENGTH_SHORT).show()
            }
        })
    }
