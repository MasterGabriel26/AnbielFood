...
import com.example.anbiel.databinding.ActivityShushiBinding
...
class ShushiActivity : AppCompatActivity() {
    private lateinit var binding : ActivityShushiBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityShushiBinding.inflate(layoutInflater)
    ...
    private fun buscador() {
        ...
        myRef.addValueEventListener(object : ValueEventListener {
                ...
                searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
                    ...
                    override fun onQueryTextChange(newText: String): Boolean {
                        ...
                        val filteredList = items.filter {
                            it?.name?.contains(newText, ignoreCase = true) == true && it.category == "Shushi"
                        }
            ...
            override fun onCancelled(error: DatabaseError) {
                ...
                Toast.makeText(this@ShushiActivity, "Error al obtener los datos de la base de datos: $error", Toast.LENGTH_SHORT).show()
            }
        })
    }
