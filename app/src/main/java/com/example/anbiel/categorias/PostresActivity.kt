...
import com.example.anbiel.databinding.ActivityPostresBinding
    ...
    private fun buscador() {
        ...
        myRef.addValueEventListener(object : ValueEventListener {
                ...
                searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
                    ...
                    override fun onQueryTextChange(newText: String): Boolean {
                        ...
                        val filteredList = items.filter {
                            it?.name?.contains(newText, ignoreCase = true) == true && it.category == "Postres"
                        }
            ...
            override fun onCancelled(error: DatabaseError) {
                ...
                Toast.makeText(this@PostresActivity, "Error al obtener los datos de la base de datos: $error", Toast.LENGTH_SHORT).show()
            }
        })
    }
